...
Function New-ARMObjects
{
    ...
    foreach ($Object in $ARMObjects) {
        ...
        if($Object.ObjectType -eq "Function") {
            ...
            $Result = Invoke-AzRestMethod -Path "$FunctionAppId/host/default/functionKeys/WinGetRestSourceAccess?api-version=2024-04-01" -Method PUT -Payload (@{name = "WinGetRestSourceAccess"; value = $NewFunctionKeyValue} | ConvertTo-Json -Depth 8)
